...
import { currentUser, fetchUser, findUniqueUser, login, refreshToken, register, updateUser } from '../controllers/userController.js'
...
userRoute.patch('/users/update/:id', updateUser)
